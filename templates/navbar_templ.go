...
func Navbar(categories []string, currentCategory string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<nav class=\"navbar\"><div class=\"container navbar-content\"><a href=\"/\" class=\"site-title\">Model Viewer</a><div class=\"nav-controls\"><input type=\"search\" id=\"search-input\" class=\"nav-input\" placeholder=\"Search models...\" onkeyup=\"handleSearch(event)\"> <select id=\"category-select\" class=\"nav-input\" onchange=\"handleCategoryChange(this.value)\"><option value=\"all\"")
		if templ_7745c5c3_Err != nil {
		...
		for _, category := range categories {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/navbar.templ`, Line: 27, Col: 43}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/navbar.templ`, Line: 30, Col: 70}
			}
